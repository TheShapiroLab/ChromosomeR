...
ChrRi_FLZ = Data from the CRISPRi ChrR-Trisomic Strain Experiments (FLZ).
ChrRi_POS = Data from the CRISPRi ChrR-Trisomic Strain Experiments (POS).
ComboA_FLZ = Data from the Combination Overexpression CRISPRa Strain Experiments (FLZ).
ComboA_POS = Data from the Combination Overexpression CRISPRa Strain Experiments (POS).
